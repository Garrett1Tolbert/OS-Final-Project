...
int sellLastSeats(int seatsleft, int numberofTickets){
    ...
    while(seatsleft - numberofTickets != 0){
        printf("number of seatsleft: %d, numberofTickets: %d\n", seatsleft,numberofTickets);
        numberofTickets--;
    }
  return numberofTickets;
}
bool addTicket(Stadium *techxarena){
     //store the seats left in the stadium and pick a number of tickets
...
void requestTicket(Ticket **listoftickets, Ticket *newTicket){
     //function that adds a ticket the ticket list
...
void sellTicket(Stadium *techxarena){
    ...
    //take a ticket from the front of the list
     ...
     if(techxarena->seats_left - sellticket->number_of_tickets < 0){
             int numberoftickets = sellLastSeats(techxarena->seats_left, sellticket->number_of_tickets);
             sellticket->number_of_tickets = numberoftickets; 
